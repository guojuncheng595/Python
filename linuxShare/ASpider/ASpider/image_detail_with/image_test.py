...
def load_dataset():
    ...
    for i in "23456789ABVDEFGHKMNPRSTUVWXYZ":
        target_path = "D:\Desktop\python-learning\linuxShare\ASpider\ASpider\image_detail_with\image\\" + i
        print(target_path)
...
def check_everyone(model):
    ...
    for i in "23456789ABCDEFGHKMNPRSTUVWXYZ":
        part_path = "D:\Desktop\python-learning\linuxShare\ASpider\ASpider\image_detail_with\image\\" + i
